    ...
    <Popover
      className={classNames(
        scrollPosition > 0
          ...
          : "shadow-none",
        "sticky top-0 z-20 h-20 flex justify-between items-center px-2 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.5)] transition-shadow opacity-95 text-white text-2xl font-bold"
      )}
    >
      <div>
        <Logo />
